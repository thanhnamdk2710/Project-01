...
<article class="aside-right col-md-3 block">
	<div class="panel panel-primary">
		...
		<div class="panel-body">
			<ul>
				<?php
					$sql_hot_post = "SELECT * FROM posts WHERE cate_1_id = 3 AND status = 1 ORDER BY id_post ASC LIMIT 0, 3";
					foreach ($db->fetch_assoc($sql_hot_post, 0) as $data_post) {
				?>
				<li>
					<a href="<?= $_DOMAIN . $data_post['slug'] . '-' . $data_post['id_post'] ?>.html"><img src="<?= $_DOMAIN . $data_post['url_thumb'] ?>"></a>
